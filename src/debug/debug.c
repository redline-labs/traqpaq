...
void debug_task( void *pvParameters ) {
	...
	usart_putchar(DEBUG_USART, DEBUG_CR);
	usart_putchar(DEBUG_USART, DEBUG_LF);
	usart_write_line(DEBUG_USART, "APPL_CPU_SPEED: ");
	print_ulong(DEBUG_USART, APPL_CPU_SPEED);
	usart_putchar(DEBUG_USART, DEBUG_CR);
	usart_putchar(DEBUG_USART, DEBUG_LF);
	usart_write_line(DEBUG_USART, "APPL_PBA_SPEED: ");
	print_ulong(DEBUG_USART, APPL_PBA_SPEED);
	usart_putchar(DEBUG_USART, DEBUG_CR);
	usart_putchar(DEBUG_USART, DEBUG_LF);
	usart_write_line(DEBUG_USART, "APPL_HSB_SPEED: ");
	print_ulong(DEBUG_USART, APPL_HSB_SPEED);
	usart_putchar(DEBUG_USART, DEBUG_CR);
	usart_putchar(DEBUG_USART, DEBUG_LF);
	usart_write_line(DEBUG_USART, "SPI_BAUDRATE: ");
	print_ulong(DEBUG_USART, SPI_BAUDRATE);
	usart_putchar(DEBUG_USART, DEBUG_CR);
	usart_putchar(DEBUG_USART, DEBUG_LF);
	usart_write_line(DEBUG_USART, "FUEL_TWI_BAUDRATE: ");
	print_ulong(DEBUG_USART, FUEL_TWI_BAUDRATE);
	usart_putchar(DEBUG_USART, DEBUG_CR);
	usart_putchar(DEBUG_USART, DEBUG_LF);
	usart_write_line(DEBUG_USART, "GPS_USART_BAUD: ");
	print_ulong(DEBUG_USART, GPS_USART_BAUD);
	usart_putchar(DEBUG_USART, DEBUG_CR);
	usart_putchar(DEBUG_USART, DEBUG_LF);
	usart_write_line(DEBUG_USART, "------------------------------");
	usart_putchar(DEBUG_USART, DEBUG_CR);
