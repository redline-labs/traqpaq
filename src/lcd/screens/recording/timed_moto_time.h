...
if(lcd_redraw_required()){
	menu_clear(&mainMenu);
	menu_addItem(&mainMenu, "10 Minutes",	LCDFSM_START_RECORD);
	menu_addItem(&mainMenu, "20 Minutes",	LCDFSM_START_RECORD);
	menu_addItem(&mainMenu, "30 Minutes",	LCDFSM_START_RECORD);
