/******************************************************************************
 *
 * Options -> Display -> Screen Timeout
 *
...
if(lcd_redraw_required()){
	menu_clear(&mainMenu);
	menu_addItem(&mainMenu, "15 seconds",	LCDFSM_DISPLAY);
	menu_addItem(&mainMenu, "30 seconds",	LCDFSM_DISPLAY);
	menu_addItem(&mainMenu, "1 minute",		LCDFSM_DISPLAY);
	menu_addItem(&mainMenu, "3 minutes",	LCDFSM_DISPLAY);
	menu_addItem(&mainMenu, "5 minutes",	LCDFSM_DISPLAY);
