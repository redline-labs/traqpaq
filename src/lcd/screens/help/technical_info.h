...
if(lcd_redraw_required()){
	...
	lcd_writeText_8x16("TRAQPAQ_DEBUG_ENABLED", FONT_SMALL_POINTER, LCD_MIN_X + 5, LCD_MAX_Y - LCD_TOPBAR_THICKNESS - 116, COLOR_BLACK);
	lcd_writeText_8x16(lcd_flagToASCII(TRAQPAQ_DEBUG_ENABLED), FONT_SMALL_POINTER, LCD_MIN_X + 307, LCD_MAX_Y - LCD_TOPBAR_THICKNESS - 116, COLOR_RED);
	
	lcd_writeText_8x16("TRAQPAQ_BATTERY_TEST_MODE", FONT_SMALL_POINTER, LCD_MIN_X + 5, LCD_MAX_Y - LCD_TOPBAR_THICKNESS - 132, COLOR_BLACK);
	lcd_writeText_8x16(lcd_flagToASCII(TRAQPAQ_BATTERY_TEST_MODE), FONT_SMALL_POINTER, LCD_MIN_X + 307, LCD_MAX_Y - LCD_TOPBAR_THICKNESS - 132, COLOR_RED);
