...
if(lcd_redraw_required()){
	...
	lcd_writeText_8x16("TRAQPAQ_32MB_FLASH", FONT_SMALL_POINTER, LCD_MIN_X + 5, LCD_MAX_Y - LCD_TOPBAR_THICKNESS - 164, COLOR_BLACK);
	lcd_writeText_8x16(lcd_flagToASCII(TRAQPAQ_32MB_FLASH), FONT_SMALL_POINTER, LCD_MIN_X + 307, LCD_MAX_Y - LCD_TOPBAR_THICKNESS - 164, COLOR_RED);
