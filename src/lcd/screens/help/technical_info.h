...
if(lcd_redraw_required()){
	...
	lcd_writeText_8x16("TRAQPAQ_GPS_ECHO_MODE", FONT_SMALL_POINTER, LCD_MIN_X + 5, LCD_MAX_Y - LCD_TOPBAR_THICKNESS - 164, COLOR_BLACK);
	lcd_writeText_8x16(lcd_flagToASCII(TRAQPAQ_GPS_ECHO_MODE), FONT_SMALL_POINTER, LCD_MIN_X + 307, LCD_MAX_Y - LCD_TOPBAR_THICKNESS - 164, COLOR_RED);
