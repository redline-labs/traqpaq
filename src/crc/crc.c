...
static void init_crc16_tab( void ) {
    ...
    for (i=0; i<256; i++) {
        ...
        for (j=0; j<8; j++) {
            ...
            if ( (crc ^ c) & 0x0001 ) crc = ( crc >> 1 ) ^ CRC_P_16;
            else                      crc =   crc >> 1;
...
static void init_crckermit_tab( void ) {
    ...
    for (i=0; i<256; i++) {
        ...
        for (j=0; j<8; j++) {
            ...
            if ( (crc ^ c) & 0x0001 ) crc = ( crc >> 1 ) ^ CRC_P_KERMIT;
            else                      crc =   crc >> 1;
...
static void init_crcdnp_tab( void ) {
    ...
    for (i=0; i<256; i++) {
        ...
        for (j=0; j<8; j++) {
            ...
            if ( (crc ^ c) & 0x0001 ) crc = ( crc >> 1 ) ^ CRC_P_DNP;
            else                      crc =   crc >> 1;
...
static void init_crc32_tab( void ) {
    ...
    for (i=0; i<256; i++) {
        ...
        for (j=0; j<8; j++) {
            ...
            if ( crc & 0x00000001L ) crc = ( crc >> 1 ) ^ CRC_P_32;
            else                     crc =   crc >> 1;
        }
...
static void init_crcccitt_tab( void ) {
    ...
    for (i=0; i<256; i++) {
        ...
        for (j=0; j<8; j++) {
            ...
            if ( (crc ^ c) & 0x8000 ) crc = ( crc << 1 ) ^ CRC_P_CCITT;
            else                      crc =   crc << 1;
